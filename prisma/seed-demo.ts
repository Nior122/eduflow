...
async function main() {
  ...
  // Resolve the demo school's id (from a previous run, if any) so the scoped
  // wipe can filter by scalar schoolId — nested `{ school: { slug } }` filters
  // are invalid inside Prisma relation where-clauses (schoolId is a scalar).
  const existingDemoSchool = await prisma.school.findUnique({
    where: { slug: DEMO_SCHOOL_SLUG },
  });
  const demoSchoolId = existingDemoSchool?.id ?? "__none__";


  // ── 1. Scoped wipe: remove ONLY the demo tenant's previous data ──────
  await prisma.$transaction([
    prisma.performanceAnalysis.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.aIReportComment.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.lessonPlan.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.message.deleteMany({ where: { sender: { schoolId: demoSchoolId } } }),
    prisma.notification.deleteMany({ where: { user: { schoolId: demoSchoolId } } }),
    prisma.announcement.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.receipt.deleteMany({ where: { payment: { schoolId: demoSchoolId } } }),
    prisma.invoicePayment.deleteMany({ where: { payment: { schoolId: demoSchoolId } } }),
    prisma.invoiceItem.deleteMany({ where: { invoice: { student: { schoolId: demoSchoolId } } } }),
    prisma.latePayment.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.invoice.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.paymentPlan.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.discount.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.payment.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.feeRecord.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.fee.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.paymentGatewayConfig.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.assessmentScore.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.examinationClass.deleteMany({ where: { examination: { schoolId: demoSchoolId } } }),
    prisma.examination.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.resultApprovalRecord.deleteMany({ where: { result: { student: { schoolId: demoSchoolId } } } }),
    prisma.result.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.reportCard.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.transcript.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.promotionRecord.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.graduationRecord.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.gradeBand.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.assessmentType.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.termAssessmentConfig.deleteMany({ where: { term: { schoolId: demoSchoolId } } }),
    prisma.timetableEntry.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.classroom.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.staffAttendance.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.teacherAssignment.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.calendarEvent.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.assignmentSubmission.deleteMany({ where: { assignment: { schoolId: demoSchoolId } } }),
    prisma.assignment.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.homeworkSubmission.deleteMany({ where: { homework: { schoolId: demoSchoolId } } }),
    prisma.homework.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.classSubject.deleteMany({ where: { class: { schoolId: demoSchoolId } } }),
    prisma.studentTimeline.deleteMany({ where: { student: { schoolId: demoSchoolId } } }),
    prisma.schoolDocument.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.userPreference.deleteMany({ where: { user: { schoolId: demoSchoolId } } }),
    prisma.userActivityLog.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.aiUsageLog.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.aiConversation.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.promptTemplate.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.aiSetting.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.knowledgeBaseDocument.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.subscription.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.schoolOnboarding.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.feeCategory.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.department.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.student.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.teacher.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.parent.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.user.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.class.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.subject.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.academicTerm.deleteMany({ where: { schoolId: demoSchoolId } }),
    prisma.academicSession.deleteMany({ where: { schoolId: demoSchoolId } }),
