...
const navItems: NavItem[] = [
  ...
  { label: "Fees", icon: DollarSign, href: "/admin/fees", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Finance Dashboard", icon: Wallet, href: "/admin/finance/dashboard", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Billing & Invoices", icon: FileText, href: "/admin/billing", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Payments", icon: CreditCard, href: "/admin/payments", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Receipts", icon: Receipt, href: "/admin/receipts", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Discounts & Scholarships", icon: Percent, href: "/admin/discounts", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Outstanding & Plans", icon: AlertTriangle, href: "/admin/outstanding", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Finance Reports", icon: BarChart3, href: "/admin/finance/reports", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Audit Log", icon: History, href: "/admin/finance/audit", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Payment Gateways", icon: ShieldCheck, href: "/admin/finance/gateways", roles: ["FINANCE_OFFICER", "SUPER_ADMIN", "SCHOOL_ADMIN"] },
  ...
  { label: "Parents", icon: Users, href: "/admin/parents", roles: ["SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Departments", icon: BookMarked, href: "/admin/departments", roles: ["SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Academic Setup", icon: ClipboardCheck, href: "/admin/academic-setup", roles: ["SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "Classrooms", icon: BookOpen, href: "/admin/classrooms", roles: ["SUPER_ADMIN", "SCHOOL_ADMIN"] },
  { label: "School Settings", icon: Settings, href: "/admin/school-settings", roles: ["SUPER_ADMIN", "SCHOOL_ADMIN"] },
